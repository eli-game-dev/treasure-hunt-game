...
public class Scoreboard : MonoBehaviour
{
    ...
    [Header("Test")] [SerializeField] private string testEntryName = "New Name";
    ...
    private void UpdateUI(ScoreboardSaveData savedScores)
    {
        ...
        {
            Instantiate(scoreboardEntryObject, highscoresHolderTransform).GetComponent<ScoreboardEntryUI>()
